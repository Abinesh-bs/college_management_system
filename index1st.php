...
if(isset($_POST['submit']))
 {
    ...
    if($num){
        ...
        $result=  mysqli_query($con,"update attendence_record set attendence_status='$attendence_status',date='$date' where register_number='$rno' and date ='$date'");
}if($result){
    $update=1;
}
}
...
<div class="panel panel-default">
    <div class="panel panel-heading">
        <h2>
            <a class="btn btn-info pull-right" href="showattendence1st.php">View All</a>
        </h2>
        ...
        <div class="panel panel-body">
            <form action="index1st.php" method="Post">
                <table class="table table-striped">
                   ...
                   $result = mysqli_query($con, "select * from students  where rno like '22%' and class_name='$course' order by name asc");
