...
?>
        <form action="index3rd.php" method="post">

<div class="panel panel-default">
    <div class="panel panel-heading">
  <h1 class="text-center">Attendance Report</h1>
        <h2>
            <a class="btn btn-info pull-right" href="showattendence3rd.php">View All</a>
        </h2>
       ...
       <?php if($flag) { ?>
        ...
        <label  class="control-label">Select Department : </label>
         ...
         <?php
         $class_result=mysqli_query($con,"SELECT distinct `name` FROM `class`");
        ...
        <div class="panel panel-body">
                ...
                <table class="table table-striped">
                   ...
                   $result = mysqli_query($con, "select * from students  where rno like '20%' and class_name='$course' order by name asc");
